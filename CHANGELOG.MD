...
## [v0.3.1] - 2024-11-08
### Fixed
- Fixed menu not showing on windows
- Prevent incorrect menu item text on macOS (by never changing it)
...
- Folder level settings caching
  - Automatically reload previous settings
  - Add menu option to clear cached settings
